...
# Replace YAML image with the newly generated one ..
	git checkout 493339e8 /home/hshamji/contour/examples/contour/03-contour.yaml
	sed -i "s/HASHPLACEHOLDER/$(VERSION)/g" /home/hshamji/contour/examples/contour/03-contour.yaml
